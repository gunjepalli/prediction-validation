...
// sum of errors are caluclated and their count for each hour, to directly find the average based on window size using these
//values, to reduce computation
	public void calculateHourlyValues(){
		...
		for(int i=0;i<predictedValues.size();i++){  //Iterating through predicted values
			...
			System.out.println("Predicted = "+predicted[0]);
